...
function (_Request) {
  ...
  function ObjectRequest(locatorInfo, reference) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(ObjectRequest).call(this, locatorInfo, reference));
...
function (_Request2) {
  ...
  function AdapterRequest(locatorInfo, reference) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(AdapterRequest).call(this, locatorInfo, reference));
