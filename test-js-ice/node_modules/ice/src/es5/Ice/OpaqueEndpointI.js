...
function (_Ice$EndpointI) {
  ...
  function OpaqueEndpointI(type) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(OpaqueEndpointI).call(this));
...
function (_Ice$OpaqueEndpointIn) {
  ...
  function OpaqueEndpointInfoI(timeout, compress, rawEncoding, rawBytes, type) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(OpaqueEndpointInfoI).call(this, -1, false, rawEncoding, rawBytes));
    _this2._type = type;
    return _this2;
  }
